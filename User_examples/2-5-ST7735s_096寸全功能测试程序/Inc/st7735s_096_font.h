...
//字体:Default
//逐行式，逆向（低位在前）
__code unsigned char asc2_1206[95][12] = {
...
//字体:Default
//逐行式，逆向（低位在前）
__code unsigned char asc2_1608[95][16] = {
...
//字体取模：宋体常规小四
//逐行式，顺向（高位在前）
__code const typFNT_GB24 tfont24[] =
    {
